...
module.exports = {
  entry: {
    app: resolve('src/entry/home/index.js'),
    theme: resolve('src/entry/theme/index.js')
  },
  output: {
    path: resolve('dist'),
  ...
  plugins: [
    new HtmlWebpackPlugin({
        filename: 'index.html',
        template: resolve('src/entry/home/index.html'),
        ...
        minify: {
            ...
            minifyJS: isPro ? true : false,
            minifyCSS: isPro ? true : false,
            minifyURLs: isPro ? true : false
        }
    }),
    new HtmlWebpackPlugin({
        filename: 'theme.html',
        template: resolve('src/entry/theme/index.html'),
        favicon: resolve('./favicon.ico'),
        chunks: ['theme'],
        inject: true,
        minify: {
